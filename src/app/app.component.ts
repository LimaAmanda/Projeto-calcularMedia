...
export class AppComponent implements OnInit {
  ...
  public nota1 : number = 10;
  public nota2 : number = 10;
  public nota3 : number = 5;
  public nota4 : number = 3;
  ...
  datavalidade:string = '2021-12-30'

  constructor()
  {
    //variavel com concatenação
    console.log('CodigoRMA :', this.codigoRMA  = 123456 );
    ...
    console.log('Media :', this.media);
        ...
        this.media
        console.log('Sua Média :',this.media)
